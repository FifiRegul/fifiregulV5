...
fait l'objet d'un document séparé : `ADMIN-NOTICE.md`, non diffuser aux utilisateurs.
...
3. Saisissez votre **Code de connexion** personnel (format type `M12345`, communiqué
...
Sur l'écran de connexion, si votre code n'est pas reconnu, un formulaire apparaît :
renseignez votre matricule, votre nom prénom et votre poste, puis cliquez sur
**Demander l'accès par e-mail** — un e-mail pré-rempli s'ouvre dans Outlook à
...
- **Véhicule** (Bus, Tram, ScoDI, Bato)
- **Sens ligne** (Aller / Retour)
- **Nom de la ligne**
- **Départ & Terminus ligne**
- **Nom de l'arrêt**
- **Commune**

Les champs "Nom de l'arrêt", "Commune", "Nom de la ligne" et "Départ & Terminus
ligne" proposent une **autocomplétion intelligente** : les suggestions se
resserrent automatiquement selon les autres critères déjà saisis (par exemple,
choisir la Commune "Cenon 33150" ne proposera plus que les arrêts de Cenon).

Une mini-carte affiche votre position GPS en permanence (sauf si cette option a
été désactivée par l'administrateur).
...
localisation, ainsi que :

- **Naviguer vers** : ouvre Google Maps, Waze ou Plans (Apple) directement sur
  les coordonnées de l'arrêt.
- **Bouton rouge ⚠️** (coin supérieur droit de chaque résultat) : **Signaler une
  erreur de géolocalisation**. Une confirmation vous rappelle qu'il faut être
...
- Vos données de connexion (code, acceptation des CGU) restent stockées
  uniquement sur votre propre appareil.
- Si l'application affiche une base de données visiblement obsolète, contactez
  votre administrateur : une mise à jour est peut-être disponible.
